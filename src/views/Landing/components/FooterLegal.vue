  ...
  <footer class="bg-neutral-900 text-neutral-400 py-16 px-8 border-t border-neutral-800">
    <div class="max-w-7xl mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div class="md:col-span-2">
          <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-2xl font-bold text-white tracking-tight">Organisasi<span class="text-primary-500">Hub</span></span>
          </div>
          <p class="text-neutral-400 leading-relaxed max-w-sm mb-6">
            Membangun ekosistem komunitas yang terintegrasi, transparan, dan berdampak nyata bagi kesejahteraan masyarakat.
          </p>
          <div class="flex gap-4">
            <!-- Social Icons -->
            <a href="#" class="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center hover:bg-primary-600 hover:text-white transition-colors">
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm">
            ...
            <li><a href="#" class="hover:text-primary-400 transition-colors">Berita Terkini</a></li>
            <li><a href="#" class="hover:text-primary-400 transition-colors">Agenda Kegiatan</a></li>
            <li><a href="#" class="hover:text-primary-400 transition-colors">Pendaftaran Anggota</a></li>
          </ul>
        </div>
      ...
      <div class="pt-8 border-t border-neutral-800 flex flex-col md:flex-row items-center justify-between text-xs text-neutral-500">
        <p>&copy; {{ new Date().getFullYear() }} Organisasi Hub. Hak cipta dilindungi undang-undang.</p>
